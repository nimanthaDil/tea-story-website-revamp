                ...
                <div class="col-xl-6">
                    <div class="product-details__content">
                        <div class="tr-wrapper d-flex align-items-center justify-content-between">
                            <h2 class="title">Ceylon Green Tea T92</h2>

                        </div>


                        <h3 class="price">80g - $18</h3>
                      

                        <div class="product-quantity d-flex align-items-center">
                            <span>Quantity</span>
                            <input type="number" placeholder="1">
                            <a class="site-btn" href="https://teastorylk.com/shop/product/ceylon-green-tea-t92-80g/">add to cart</a>
                        </div>
