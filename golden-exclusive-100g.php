                ...
                <div class="col-xl-6">
                    <div class="product-details__content">
                        <div class="tr-wrapper d-flex align-items-center justify-content-between">
                            <h2 class="title">Golden Exclusive - 100g</h2>

                        </div>


                        <h3 class="price">100g - $90</h3>
                       

                        <div class="product-quantity d-flex align-items-center">
                            <span>Quantity</span>
                            <input type="number" placeholder="1">
                            <a class="site-btn" href="https://teastorylk.com/shop/product/golden-exclusive-100g/">add to cart</a>
                        </div>
