                ...
                <div class="col-xl-6">
                    <div class="product-details__content">
                        <div class="tr-wrapper d-flex align-items-center justify-content-between">
                            <h2 class="title">Premium White Tea - 50g</h2>

                        </div>


                        <h3 class="price">50g - $35</h3>
                       

                        <div class="product-quantity d-flex align-items-center">
                            <span>Quantity</span>
                            <input type="number" placeholder="1">
                            <a class="site-btn" href="https://teastorylk.com/shop/product/premium-white-tea-50g/">add to cart</a>
                        </div>
